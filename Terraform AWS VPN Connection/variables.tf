# Sample values for variables.tf

variable "vpc_id" {
  type        = string
  description = "The ID of the VPC to which the Virtual Private Gateway will be attached"
  default     = "vpc-041239e1192d0d5ab"  # Replace with your actual VPC ID
}
...
variable "customer_gateway_device_name" {
  ...
  default     = "MyCustomerGateway"
}

variable "customer_gateway_bgp_asn" {
  type        = number
  description = "The Customer Gateway's BGP ASN"
  default     = 65000
}
...
variable "customer_gateway_ip_address" {
  ...
  default     = "203.0.113.1"  # Replace with your actual customer gateway IP address
}

variable "route_table_ids" {
  type        = list(string)
  description = "The IDs of the route tables for which routes from the Virtual Private Gateway will be propagated."
  default     = ["rtb-081ea7a7cf6c6fb2f"]  # Replace with your actual route table ID(s)
}
